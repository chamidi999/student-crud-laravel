...
<body>
    ...
    <div class="main-header">
        <div class="container">
            ...
            <p class="mb-0 mt-2">Add new student information</p>
        </div>
    </div>
                ...
                <form action="{{ route('students.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('course') is-invalid @enderror" 
                            ...
                            <option value="Electrical Engineering" {{ old('course') == 'Electrical Engineering' ? 'selected' : '' }}>Electrical Engineering</option>
                            <option value="Mechanical Engineering" {{ old('course') == 'Mechanical Engineering' ? 'selected' : '' }}>Mechanical Engineering</option>
                            <option value="Civil Engineering" {{ old('course') == 'Civil Engineering' ? 'selected' : '' }}>Civil Engineering</option>
                            <option value="Mathematics" {{ old('course') == 'Mathematics' ? 'selected' : '' }}>Mathematics</option>
                            <option value="Physics" {{ old('course') == 'Physics' ? 'selected' : '' }}>Physics</option>
                            <option value="Chemistry" {{ old('course') == 'Chemistry' ? 'selected' : '' }}>Chemistry</option>
                        </select>
                        @error('course')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
